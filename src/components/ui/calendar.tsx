    ...
    <DayPicker
      ...
      classNames={{
        ...
        month_caption: cn(
          ...
          "h-[var(--cell-size)] px-[var(--cell-size)]",
      ...
      components={{
        ...
        WeekNumber: ({ children, ...props }) => {
          return (
            <td {...props}>
              <div className="flex items-center justify-center text-center w-[var(--cell-size)] h-[var(--cell-size)]">
                {children}
              </div>
            </td>
          )
