      ...
      <DashboardLayout role="instructor" uid={uid}>
        <div className="space-y-6">
          <div>
            ...
            <p className="mt-2 text-gray-600">Manage your courses and engage with students.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border hover:shadow-md transition-shadow">
              <h2 className="text-xl font-semibold mb-4 text-purple-600">Assignments</h2>
              <p className="text-gray-600">Create and grade assignments.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm border hover:shadow-md transition-shadow">
              <h2 className="text-xl font-semibold mb-4 text-orange-600">Reports</h2>
              <p className="text-gray-600">View class performance reports.</p>
            </div>
          </div>
        </div>
      </DashboardLayout>
